...
@section('content')
 <body class="sticky-header left-side-collapsed">
    ...
    <!-- left side end-->
     ...
     <!--body wrapper start-->
			<div id="page-wrapper">
        @Component('components.structure.page-title',['title'=>'New customer'])@endcomponent
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            @Component('components.form-inputs.select',['title' => 'Type','name'=>'type','icon'=>'fas fa-user-tag','options'=>$userTypes,'required'=>false,'selected'=>2])@endcomponent
