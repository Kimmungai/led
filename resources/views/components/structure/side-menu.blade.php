  ...
  <div class="left-side-inner">
    ...
    <!--sidebar nav start-->
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list @if(Route::is('sales*')) active @endif">
        ...
        <li class="menu-list @if(Route::is('purchases*')) active @endif">
        ...
        <li class="menu-list @if(Route::is('stock*')) active @endif"><a href="{{route('stock.index')}}"><i class="fa fa-clipboard-list"></i> <span>Stock</span></a></li>
        <li class="@if(Route::is('customers*')) active @endif">
          <a href="{{route('customers.index')}}"><i class="fa fa-users"></i>
            <span>Customers</span></a>
            <ul class="sub-menu-list">
              <li><a href="{{route('customers.index')}}">Open all</a> </li>
              <li><a href="{{route('customers.create')}}">Add new</a></li>
            </ul>
        </li>
        <li class="menu-list @if(Route::is('invoice*')) active @endif">
        ...
        <li class="menu-list @if(Route::is('users*')) active @endif"><a href="{{route('users.index')}}"><i class="fa fa-user-tie"></i> <span>Users</span></a>
          <ul class="sub-menu-list">
        ...
        <li class="menu-list @if(Route::is('reports*')) active @endif"><a href="{{route('reports.index')}}"><i class="fa fa-chart-area"></i> <span>Reports</span></a>
          <ul class="sub-menu-list">
        ...
        <li class="@if(Route::is('trash.index')) active @endif"><a href="{{route('trash.index')}}"><i class="fa fa-trash-alt"></i> <span>Trash</span></a></li>
      </ul>
    <!--sidebar nav end-->
  </div>
</div>
