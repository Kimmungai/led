...
@Component('components.modals.confirm',['title'=>'Delete user','question'=>'Are you sure you want to delete '.$user->name.'?','modalID'=>'DELUserConfirmModal-'.$user->id,'cancelBtnTitle'=>'Cancel','saveBtnTitle'=>'Confirm save','formID'=>'delete-user-'.$user->id.'-form'])@endcomponent
