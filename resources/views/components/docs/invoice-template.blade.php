  <div class="invoice-panel">
    ...
    <div class="row">
      <div class="col-xs-12">
        <p class="title-2">
          <span>
            <strong id="{{$docId}}-title-2" class="" onclick="edit_doc_field(this.id)">Monthly report</strong>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="heading">
          <h1>
            <strong id="{{$docId}}-heading" onclick="edit_doc_field(this.id)">Rent and Beyond</strong>
            <input id="{{$docId}}-heading-input" type="text" class="hidden" name="" value="" onfocusout="save_doc_field('{{$docId}}-heading',this.value)">
          </h1>
          <p>
            <strong id="{{$docId}}-sub-heading" onclick="edit_doc_field(this.id)">P.o Box xxx Nairobi-Kenya</strong>
      ...
      <div class="col-xs-6">
        <div class="doc-ids">
          ...
          <p onclick="edit_doc_field('{{$docId}}-doc-id-date')">
            Period:
            <strong id="{{$docId}}-doc-id-date" >July 2020</strong>
      ...
      <div class="col-xs-12">
            ...
            <tbody id="{{$docId}}-table-body">
              ...
              <tr id="{{$docId}}-table-body-row-1">
                <td data-label="Qty."><!--<span class="fas fa-times-circle" onclick="remove_table_row('{{$docId}}-table-body-row-1','{{$docId}}-table-body')"></span>-->
                  <strong id="{{$docId}}-table-body-row-1-td-1" onclick="edit_doc_field(this.id)">Double apartment</strong>
                ...
                <td data-label="Description">
                  <strong id="{{$docId}}-table-body-row-1-td-2" onclick="edit_doc_field(this.id)">Advertising</strong>
                ...
                <td data-label="@">
                  <strong id="{{$docId}}-table-body-row-1-td-3" onclick="edit_doc_field(this.id)">1</strong>
        ...
        <div class="footnote">
          ...
          <p class="mt-2" onclick="edit_doc_field('{{$docId}}-foot-note-p-4')">
            <strong id="{{$docId}}-foot-note-p-4" >This is an autogenerated report</strong>
