        ...
        <!--custom page design starts-->
          ...
          <div class="row">
            ...
            @forelse($posts as $post)
              @Component('components.dashboard.post',['title'=>$post->title,'post'=>$post,'icon'=>'fa fa-check-circle','link'=>route('post.show',$post->id),'color'=>'#5cb85c','selectable'=>true])@endcomponent
            @empty
