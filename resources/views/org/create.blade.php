 ...
 <body class="sticky-header left-side-collapsed">
    ...
    <!-- left side end-->
     ...
     <!--body wrapper start-->
        ...
        <div class="row">
          <form id="new-org-form" action="{{route('org.store')}}" method="post" onsubmit="confirm_modal('newOrgConfirmModal')">
            @csrf
          ...
          <div class="col-md-4">
            <div class="avatar-preview">
              ...
              <img id="org-img" class="" src="@if( old('image') ) {{url(old('image'))}} @else /placeholders/avatar-male.png @endif" alt="" >
            ...
            @Component('components.form-inputs.side-textarea',['title' => 'Remarks','name'=>'description','icon'=>'fas fa-info-circle','placeholder' => 'Enter a brief description','rows'=>3,'cols'=>'','required'=>false])@endcomponent
...
<!--modals-->
@Component('components.modals.confirm',['title'=>'Save new organisation','question'=>'Are you sure you want to save organisation?','modalID'=>'newOrgConfirmModal','cancelBtnTitle'=>'Cancel','saveBtnTitle'=>'Confirm save','formID'=>'new-org-form'])@endcomponent
